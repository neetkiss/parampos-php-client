...
use Param\PhpSdk\Interface\IKartSaklamaliOdeme;
use Param\PhpSdk\Features\G;

class KS_Tahsilat extends Config implements IKartSaklamaliOdeme
{
    ...
    {
        $this->Data1 = $Data1 . "|SDK_PHP_" . $this->version . "_KS_Tahsilat";
    }
