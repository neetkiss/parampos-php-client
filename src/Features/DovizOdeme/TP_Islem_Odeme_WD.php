...
use Param\PhpSdk\Interface\IDovizOdeme;
use Param\PhpSdk\Features\G;

class TP_Islem_Odeme_WD extends Config implements IDovizOdeme
{
    protected string $Doviz_Kodu;
    ...
    public function setDoviz_Kodu($Doviz_Kodu)
    {
        $this->Doviz_Kodu = $Doviz_Kodu;
    }
    ...
    {
        $this->Data1 = $Data1 . "|SDK_PHP_" . $this->version . "_TP_Islem_Odeme_WD";
    }
